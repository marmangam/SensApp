// Este archivo define el fragmento `ResponsablesAddFragment`.
// Permite a los administrativos crear un nuevo responsable para un nuevo usuario.
...
import com.example.apptrabajadores.databinding.FragmentAddResponsablesBinding;
...
public class ResponsablesAddFragment extends Fragment {
    // Variables de la clase
    private FragmentAddResponsablesBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding = FragmentAddResponsablesBinding.inflate(inflater, container, false);
        ...
        boton_crear.setOnClickListener(v -> {
            ...
            if(usuarios_responsables.contains(nuevousuario)) {
                ...
                crear_resposable(nuevonombre, nuevoapellido, nuevousuario, nuevotelefono, nuevodni, dni_usuario, nuevapassword);
            }
        });
    ...
    public void crear_resposable(String nombre, String apellidos, String usuario, Integer telefono, String dni, String dni_usuario, String password) {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, URL, new_responsable,
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            if (response.getString("message").equals("Insertado")) {
                                ...
                                // En caso de que el responsable se cree correctamente, se  pregunta si se desea añadir otro responsable
                                ...
                                mensaje.setText("¿Desea añadir otro responsable?");
                                ...
                                builder.setCancelable(false)
                                        .setPositiveButton("Sí", (dialog, which) -> {
                                            ...
                                            bundle.putString("dni_usuario", dni_usuario);
                                            Log.d("UsuariosFragment", "JSON del usuario: " + dni_usuario);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(activity.getApplicationContext(),
                        "Se ha producido un error creando el responsable", Toast.LENGTH_SHORT).show();
                error.printStackTrace();

...
public class ListaAdaptadorEventos extends RecyclerView.Adapter<ListaAdaptadorEventos.EventoViewHolder> {
    ...
    private final OnEventoClickListener onEventoClickListener;
    ...
    public void onBindViewHolder(@NonNull EventoViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> onEventoClickListener.onEventoClick(evento));
        holder.itemView.setOnLongClickListener(v -> {
            onEventoClickListener.onEventoLongClick(evento);
            return true;
        });
    }
